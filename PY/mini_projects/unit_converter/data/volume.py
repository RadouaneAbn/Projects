...
from_name = to_name = "Cubic Meter"
in_mes = out_mes = 1

mes_list = [1, 1000000000, 0.000001, 1.E-9, 0.001, 0.000001, 0.00378541,
            0.0009463525, 4168180000, 0.764554858, 0.0283168466, 0.0000163871]

mes_names =[
    "Cubic Meter", "Cubic Kilometer", "Cubic Centimeter", "Cubic Milimeter", "Liter",
    "Milliliter", "US Gallon", "US Quart", "Cubic Mile", "Cubic Yard", "Cubic Foot", "Cubic Inch"]

def volume_window():
    from data import setup_page, volume_btn, volume_indicator, tk
    ...
    screen = setup_page(volume_btn, volume_indicator)

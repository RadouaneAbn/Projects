...
from_name = to_name = "Second"
in_mes = out_mes = 1

mes_list = [
    1, 0.001, 0.000001, 1.E-9, 1.E-12, 60, 3600, 86400,
    604800, 2629800, 31557600
]
...
def time_window():
    from data import setup_page, time_btn, time_indicator, tk
    ...
    screen = setup_page(time_btn, time_indicator)

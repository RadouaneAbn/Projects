...
from_name = to_name = "Square Meter"
in_mes = out_mes = 1

mes_list = [1, 1000000, 0.0001, 0.000001, 1.E-12, 10000, 2589990,
            0.83612736, 0.09290304, 0.00064516, 4046.8564224]

mes_names =[
    "Square Meter", "Square Kilometer", "Square Centimeter", "Square Millimeter", "Square Micrometer",
    "Hectare", "Square Mile", "Square Yard", "Square Foot", "Square Inch", "Arce"]

def area_window():
    from data import setup_page, area_btn, area_indicator, tk
    ...
    screen = setup_page(area_btn, area_indicator)

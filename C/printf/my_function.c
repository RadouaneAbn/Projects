...
/**
 * strcnt - This function appends a string to a buffer in given position
 * @buffer: The buffer
 * @idx: The index where the function start the append
 * @src: The source (str)
 *
 * Return: The number of character written in the buffer
 */
